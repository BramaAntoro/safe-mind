...
const mockHistory: Insight[] = [
  ...
  },
  {
    id: 2,
    content:
      "Minggu ini kamu sangat aktif dalam kategori 'Olahraga'. Ini berdampak sangat positif pada mood kamu yang rata-rata berada di level 'GREAT'.\n\nSaran AI: Pertahankan rutinitas ini, namun pastikan tidur yang cukup (7-8 jam) agar tidak mengalami burnout di minggu depan.",
  ...
  },
  {
    id: 3,
    content:
      "Ada pola kecemasan yang muncul setiap hari Selasa malam. Setelah dianalisis, ini berkaitan dengan persiapan rapat mingguanmu.\n\nSaran AI: Cobalah untuk mencicil persiapan rapat sejak hari Senin agar beban di Selasa malam berkurang.",
